...
Another data type is the Boolean.Booleans may only be one of two values: true or false.They are basically little on - off switches, where true is "on"
and false is "off."
...
function so that it returns true instead of false when the run button is clicked.
*/
