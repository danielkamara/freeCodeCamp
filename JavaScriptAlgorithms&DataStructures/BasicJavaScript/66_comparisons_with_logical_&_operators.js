...
will only return Yes if num is greater than 5 and less than 10. The same logic 
can be written as:
...
Replace the two if statements with one statement, using the && operator, which will 
